...
@pytest.mark.parametrize(
    ...
    [
        ...
        (Font(family=SYSTEM, size=SYSTEM_DEFAULT_FONT_SIZE), 1.2, (132, 12)),
        (Font(family=SYSTEM, size=20), None, (220, 20)),
        (Font(family=SYSTEM, size=20), 1.2, (220, 20)),
        (Font(family=SYSTEM, size=20), 1.8, (220, 30)),
        (Font(family="Cutive", size=SYSTEM_DEFAULT_FONT_SIZE), None, (198, 18)),
        (Font(family="Cutive", size=SYSTEM_DEFAULT_FONT_SIZE), 1.2, (198, 18)),
        (Font(family="Cutive", size=20), None, (330, 30)),
        (Font(family="Cutive", size=20), 1.2, (330, 30)),
        (Font(family="Cutive", size=20), 1.8, (330, 45)),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (Font(family=SYSTEM, size=SYSTEM_DEFAULT_FONT_SIZE), 1.2, (132, 24)),
        (Font(family=SYSTEM, size=20), None, (220, 40)),
        (Font(family=SYSTEM, size=20), 1.2, (220, 40)),
        (Font(family=SYSTEM, size=20), 1.8, (220, 60)),
        (Font(family="Cutive", size=SYSTEM_DEFAULT_FONT_SIZE), None, (198, 36)),
        (Font(family="Cutive", size=SYSTEM_DEFAULT_FONT_SIZE), 1.2, (198, 36)),
        (Font(family="Cutive", size=20), None, (330, 60)),
        (Font(family="Cutive", size=20), 1.2, (330, 60)),
        (Font(family="Cutive", size=20), 1.8, (330, 90)),
    ],
)
